...
<template>
  <div class="basis-full md:basis-1/3 text-center">
    ...
    <div class="px-3 pb-3 bg-neutral-700/80 rounded-b-sm">
      ...
      <a :href="newsService.getNewsItemUri($props.news.slug)"
         class="inline-block w-fit rounded-sm p-3 bg-dark-grey border border-dark-grey hover:border-primary hover:text-primary transition-300">
